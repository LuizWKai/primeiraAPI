...
const config = {
  "generator": {
    ...
    "output": {
      "value": "C:\\Users\\luizk\\OneDrive\\Área de Trabalho\\API YT\\backend\\src\\generated\\prisma",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "C:\\Users\\luizk\\OneDrive\\Área de Trabalho\\API YT\\backend\\prisma\\schema.prisma",
    "isCustomOutput": true
  },
  "relativeEnvPaths": {
    "rootEnvPath": null,
  ...
  "inlineSchema": "// This is your Prisma schema file,\n// learn more about it in the docs: https://pris.ly/d/prisma-schema\n\n// Looking for ways to speed up your queries, or scale easily with your serverless or edge functions?\n// Try Prisma Accelerate: https://pris.ly/cli/accelerate-init\n\ngenerator client {\n  provider = \"prisma-client-js\"\n  output   = \"../src/generated/prisma\"\n}\n\ndatasource db {\n  provider = \"mongodb\"\n  url      = env(\"DATABASE_URL\")\n}\n\nmodel Customer {\n  id         String    @id @default(auto()) @map(\"_id\") @db.ObjectId\n  name       String\n  email      String\n  status     Boolean\n  created_at DateTime? @default(now())\n  uptaded_at DateTime? @default(now())\n\n  @@map(\"customers\")\n}\n",
  "inlineSchemaHash": "15709153217fcce00a82e6e85a8dff17286e477fb8aae22e8ba49e26b5aeffe8",
  "copyEngine": true
}
